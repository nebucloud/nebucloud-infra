...
import (
	...
	xdsv1alpha1 "github.com/nebucloud/nebucloud-infra/operator/api/v1alpha1"
	"github.com/nebucloud/nebucloud-infra/pkg/xds"
...
// +kubebuilder:rbac:groups=xds.nebucloud.io,resources=listeners,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=xds.nebucloud.io,resources=listeners/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=xds.nebucloud.io,resources=listeners/finalizers,verbs=update
