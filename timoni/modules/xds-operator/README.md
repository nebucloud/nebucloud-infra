...
A [timoni.sh](http://timoni.sh) module for deploying xds-operator to Kubernetes clusters.
...
```shell
timoni -n default apply xds-operator oci://<container-registry-url>
```
...
```shell
timoni -n default delete xds-operator
```
